...
Module expr := stlc.old.expr.
Module step := stlc.old.step.
Module value := stlc.old.value.
Module type := stlc.old.type.
Module has_type := stlc.old.has_type.
...
Module expr := stlc.add_valuet_beta.expr.
Module step := stlc.add_valuet_beta.step.
Module value := stlc.add_valuet_beta.value.
Module type := stlc.add_valuet_beta.type.
Module has_type := stlc.add_valuet_beta.has_type.
...
Module expr := stlc.add_valuet_app2.expr.
Module step := stlc.add_valuet_app2.step.
Module value := stlc.add_valuet_app2.value.
Module type := stlc.add_valuet_app2.type.
Module has_type := stlc.add_valuet_app2.has_type.
